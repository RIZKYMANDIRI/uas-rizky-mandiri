...
public class MainActivity extends AppCompatActivity {
    ...
    com.example.daftarrumahmakan.DaftarRumahMakanAdapter adapter;
    List<RumahMakan> daftarTransaksi;
    ...
    private void setupListview() {
        adapter = new com.example.daftarrumahmakan.DaftarRumahMakanAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, com.example.daftarrumahmakan.FormRumahMakanActivity.class);
